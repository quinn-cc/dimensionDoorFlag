BZFlag Server Plugin: dimensionDoorFlag
================================================================================
...
dimensionDoorFlag directory to a new name, and then manually replace dimensionDoorFlag
...
To load the plugin with specific settings, use the format:
  -loadplugin dimensionDoorFlag,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin dimensionDoorFlag,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin dimensionDoorFlag,<configfilename>
For example:
  -loadplugin dimensionDoorFlag,/path/to/my/sampleplugin.cfg
